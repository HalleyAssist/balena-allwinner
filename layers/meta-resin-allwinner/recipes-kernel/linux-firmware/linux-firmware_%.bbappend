...
# These firmware files are fetched from https://github.com/armbian/build/tree/master/packages/extras/firmware/brcm and https://github.com/armbian/firmware/tree/master/brcm
SRC_URI_append = " \
    file://bcm4329.hcd \
    file://bcm4330.hcd \
